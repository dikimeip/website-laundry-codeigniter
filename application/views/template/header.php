...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>asset/libs/css/style.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>asset/vendor/fonts/fontawesome/css/fontawesome-all.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>asset/vendor/charts/chartist-bundle/chartist.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>asset/vendor/charts/morris-bundle/morris.css">
...
<body>
    ...
    <!-- Optional JavaScript -->
    <!-- jquery 3.3.1 -->
    <script src="<?php echo base_url() ?>asset/vendor/jquery/jquery-3.3.1.min.js"></script>
    <!-- bootstap bundle js -->
    <script src="<?php echo base_url() ?>asset/vendor/bootstrap/js/bootstrap.bundle.js"></script>
    <!-- slimscroll js -->
    <script src="<?php echo base_url() ?>asset/vendor/slimscroll/jquery.slimscroll.js"></script>
    <!-- main js -->
    <script src="<?php echo base_url() ?>asset/libs/js/main-js.js"></script>
    <!-- chart chartist js -->
    <script src="<?php echo base_url() ?>asset/vendor/charts/chartist-bundle/chartist.min.js"></script>
    <!-- sparkline js -->
    <script src="<?php echo base_url() ?>asset/vendor/charts/sparkline/jquery.sparkline.js"></script>
    <!-- morris js -->
